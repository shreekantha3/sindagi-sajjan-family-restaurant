# TEST REPORT — Sajjan Family Restaurant
> Tester: Senior Engg | Segment: Restaurant | Tier-4/5

## Build
- [ ] `npm run build` (pending)

## Static QA (generator asserts)
- Phone: MISSING → no tel: links by design | Maps embed (lazy iframe) + JSON-LD Restaurant schema + H1 + title<=60
- No lorem ipsum, no invented hours/prices/ratings

## Build result (2026-09-15)
- [x] `npm run build` PASS (vite 5.4.21, 0 warnings)
- dist: index 12.70 kB / CSS 11.98 kB / JS 1.17 kB — under perf budget
